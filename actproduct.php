...
$query = "SELECT id_producto, nombre, precio, imagen, descripcion, cantidad FROM producto LIMIT $productsPerPage OFFSET $offset";
        ...
        <tbody>
            <?php while($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td><a href="editar_producto.php?id_producto=<?php echo $row['id_producto']; ?>" class="edit-button">Editar</a></td>
                </tr>
            <?php endwhile; ?>
        </tbody>
    </table>
