            ...
            ?>
                ...
                <div class="producto">
                    ...
                    <?php if ($status == 'activo') { ?>
                        <!-- Producto disponible-->
                        <button class="agregar-carrito" onclick="agregarAlCarrito('<?php echo $producto['nombre']; ?>', <?php echo $producto['precio']; ?>, '<?php echo $producto['id_producto']; ?>', '<?php echo $producto['imagen']; ?>');">
